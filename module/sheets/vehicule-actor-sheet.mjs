...
export class VehiculeActorSheet extends ActorSheet {
    ...
    get template() {
        if (!game.user.isGM && this.actor.limited) {
            return `${templatesPath}/limited-vehicule-sheet.html`;
        }
    ...
    activateListeners(html) {
        ...
        commonHTML(html, this.actor, {
            ...
            hasPwr: true,
            hasStr: true,
            strInput: `div.details div.strategie input`,
            hasPP: true,
            ppName: 'cout',
            hasSpd: true,
            hasRoll: true,
    ...
    _prepareList(context) {
        ...
        for (let l of fullList) {
            const tra = CONFIG.MM4[l.toLowerCase()];
            const list = {};
    ...
    async _onItemCreate(event) {
        ...
        const itemData = {
            ...
            data: data,
            img: {
                equipement: `${assetsPath}/icons/equipment.svg`,
    ...
    async _onDropItemCreate(itemData) {
        ...
        if (itemData[0].type === 'modificateur' || itemData[0].type === 'equipement' || itemData[0].type === 'talent')
            return;
