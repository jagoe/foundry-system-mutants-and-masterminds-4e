...
export class VehiculeDataModel extends foundry.abstract.TypeDataModel {
    static defineSchema() {
        ...
        for (let c of CONFIG.MM4.LIST.VehiculeCaracteristiques) {
        ...
        let data = {
            ...
            taille: new StringField({
                ...
                choices: ['titanesque', 'colossal', 'gigantesque', 'enorme', 'grand', 'intermediaire'],
            }),
    ...
    #_cout() {
        const pouvoir = this.items
            ...
            .reduce(
                (acc, item) =>
                    acc +
                    ((item.system.special === 'dynamique' && item.system.link !== '') ||
